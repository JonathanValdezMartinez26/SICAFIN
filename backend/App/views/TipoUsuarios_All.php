<?= $header; ?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <p class="mb-6">
            Un rol proporciona acceso a menús y funciones predefinidos para que, según el rol asignado, un administrador pueda tener acceso a lo que el usuario necesita.
        </p>
        <!-- Role cards -->
        <div class="row g-6">
            ...
            <div class="col-12">
                ...
                <p class="mb-0">Encuentre todas las cuentas de administrador de la empresa y sus roles asociados.</p>
            </div>
            <div class="col-12">
                <!-- Role Table -->
                <div class="card">
